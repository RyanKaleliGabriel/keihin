...
function Services() {
  return (
    <section id="SERVICES" className="px-8 mt-24 font-popins">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="mt-4 basis-9/12">
                ...
                <p className="text-[grey] text-[12px]">
                  ...
                  consignment from the port of Mombasa, ICDN and border points
                  of Kenya including Namanga, Lunga Lunga, Kiunga etc
                </p>
              </div>
            </div>
