                ...
                <div className="flex flex-col gap-8 md:ml-20">
                    <div className="flex items-center gap-5 ">
                        ...
                        <div className="mt-4 basis-9/12">
                            ...
                            <p className="text-[lightgrey] text-[12px]">We facilitate transportation of containerized cargo, loose cargo and out-of-gauge cargo across Kenya. </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="mt-4 basis-9/12">
                            ...
                            <p className="text-[lightgrey] text-[12px]">We facilitate clearing & forwarding of all types of sea freight, including containerized cargo, bulk cargo such as wheat, Sugar, rice, cooking oil and fuel.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="mt-4 basis-9/12">
                            ...
                            <p className="text-[lightgrey] text-[12px]">We facilitate clearing and forwarding of all types of automobiles from the port of Mombasa and CFS’s within Mombasa and border points of exit. </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="mt-4 basis-9/12">
                            ...
                            <p className="text-[lightgrey] text-[12px]">We deal with collection, transportation, and disposal of garbage, sewage, and other waste products from ships at the port of Mombasa.</p>
                        </div>
                    </div>
                </div>
            </div>
